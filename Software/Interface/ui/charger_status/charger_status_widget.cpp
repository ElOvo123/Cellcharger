...
ChargerStatusWidget::ChargerStatusWidget(QWidget* parent) : QWidget(parent), ui(new Ui::ChargerStatusWidget)
{
    ...
    setStyleSheet(
        ...
        "  background-color: #ffffff;"
        "}"
        "QLabel#detailedModeLabel, QLabel#detailedSetpointLabel, QLabel#detailedSetpointUnitLabel {"
        "  color: #334252;"
        "  font-weight: 600;"
        "}"
        ...
        "  min-height: 32px;"
        "}"
        "QPushButton#startButton1, QPushButton#startButton2, QPushButton#startButton3,"
        "QPushButton#detailedStartButton {"
        "  background-color: #1f6f4a;"
        "  border-color: #2f9f6b;"
        "}"
        "QPushButton#stopButton1, QPushButton#stopButton2, QPushButton#stopButton3,"
        "QPushButton#detailedStopButton {"
        "  background-color: #7b2935;"
        "  border-color: #b94a5a;"
        "}"
        "QPushButton#capacityButton1, QPushButton#capacityButton2, QPushButton#capacityButton3,"
        "QPushButton#ecmButton1, QPushButton#ecmButton2, QPushButton#ecmButton3,"
        "QPushButton#irButton1, QPushButton#irButton2, QPushButton#irButton3,"
        "QPushButton#enduranceTestButton1, QPushButton#enduranceTestButton2, QPushButton#enduranceTestButton3 {"
        "  background-color: #eef3f7;"
        "  border-color: #c4d0dc;"
        "}");
    setupTabWidget();
...
void ChargerStatusWidget::applySlotState(int slotIndex, bool active)
{
    ...
    if (led)
    {
        ...
        led->setStyleSheet(active ? "background-color: #39d98a; border: 2px solid #178858; border-radius: 2px;"
                                  : "background-color: #e35d6a; border: 2px solid #8f2f3d; border-radius: 2px;");
